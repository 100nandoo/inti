import { l as z, w as m, m as O, n as q, q as I, t as j, u as H, v as y, x as c, y as w, z as f, A as G, B as D, C as Y, D as Q, E as X, F as $ } from "./dom-CuOumjtQ.js";
import { e as N, s as p, a as Z, t as x, u as E } from "./feed-DYy8QE9U.js";
import { d as ee, b as te } from "./download-DPH0bWHb.js";
import { updateTextMetrics as R } from "./metrics-CVlegFTT.js";
import { k as C, s as ne, l as S, p as T, m as se, d as F, j as ae, h as re, n as oe, e as ie, g as o, o as _ } from "./workspace-4tZMdcO8.js";
function g(t) {
...
function L() {
  ...
  m.value !== s && (m.value = s), m.disabled = t, z.disabled = t || !e, O.disabled = t || !e, n.kind === "summary" ? D.innerHTML = U(n.rawText) : D.innerHTML = de(n.rawText), Y.textContent = n.kind ? `${n.kind === "summary" ? "Summary" : "OCR"} result` : "No result yet", Q.textContent = n.title || "Transform result";
