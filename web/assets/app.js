...
const D = 2, Ke = 4, zt = 8, fn = 1 << 24, X = 16, oe = 32, _e = 64, Tt = 128, Y = 512, N = 1024, F = 2048, ne = 4096, ee = 8192, ve = 16384, Ve = 32768, Jt = 1 << 25, pt = 65536, At = 1 << 17, li = 1 << 18, tt = 1 << 19, cn = 1 << 20, Ce = 65536, ht = 1 << 21, vt = 1 << 22, $e = 1 << 23, Ue = Symbol("$state"), jt = new class extends Error {
  constructor() {
    super(...arguments);
...
const mt = class mt {
  ...
  schedule(t) {
    var r;
    if (Rt = t, (r = t.b) != null && r.is_pending && (t.f & (Ke | zt | fn)) !== 0 && (t.f & Ve) === 0) {
      t.b.defer_effect(t);
      return;
    }
...
Ct = function(t, n, i) {
  ...
  for (var r = t.first; r !== null; ) {
    ...
    if (!o && r.fn !== null) {
      f ? r.f ^= N : (a & Ke) !== 0 ? n.push(r) : nt(r) && ((a & X) !== 0 && s(this, se).add(r), Ge(r));
      var l = r.first;
      if (l !== null) {
        r = l;
        continue;
  ...
  for (const d of we) {
    ...
    if (r.length === 0)
      ...
      for (const c of s(this, Qe))
        (c.f & (ve | ee | At)) === 0 && Bt(c, o, f) && ((c.f & (vt | X)) !== 0 ? (T(c, F), d.schedule(c)) : s(d, de).add(c));
      if (s(d, L).length > 0) {
        d.apply();
        for (var l of s(d, L))
          E(p = d, S, Ct).call(p, l, [], []);
...
function Qt(e) {
  ...
  if (t !== 0) {
    for (var n = 0; n < t; ) {
      var i = e[n++];
      if ((i.f & (ve | ee)) === 0 && nt(i) && (H = /* @__PURE__ */ new Set(), Ge(i), i.deps === null && i.first === null && i.nodes === null && i.teardown === null && i.ac === null && Mn(i), (H == null ? void 0 : H.size) > 0)) {
        Ae.clear();
        for (const r of H) {
  ...
  if (!n.has(e) && (n.add(e), e.reactions !== null))
    for (const r of e.reactions) {
      ...
      (a & D) !== 0 ? wn(
        ...
        n,
        i
      ) : (a & (vt | X)) !== 0 && (a & F) === 0 && Bt(r, t, i) && (T(r, F), Gt(
        /** @type {Effect} */
        r
      ));
    }
...
function Ai(e) {
  let t = 0, n = Wt(0), i;
  return () => {
    Yt() && (he(n), qi(() => (t === 0 && (i = Ht(() => e(() => He(n)))), t += 1, () => {
      Pe(() => {
...
var V, It, W, Se, M, q, P, B, ae, Te, pe, je, Xe, et, le, gt, x, Oi, Di, Pi, Nt, ut, ft, Ot, Dt;
class Ni {
  /**
  ...
  constructor(t, n, i, r) {
     ...
     */
    g(this, le, null);
    g(this, gt, Ai(() => (_(this, le, Wt(s(this, Te))), () => {
      _(this, le, null);
    })));
    var a;
    _(this, V, t), _(this, W, n), _(this, Se, (f) => {
      var u = (
        /** @type {Effect} */
        y
      );
  ...
  error(t) {
    if (!s(this, W).onerror && !s(this, W).failed)
      throw t;
    m != null && m.is_fork ? (s(this, q) && m.skip_effect(s(this, q)), s(this, P) && m.skip_effect(s(this, P)), s(this, B) && m.skip_effect(s(this, B)), m.on_fork_commit(() => {
      E(this, x, Dt).call(this, t);
    })) : E(this, x, Dt).call(this, t);
  }
}
V = new WeakMap(), It = new WeakMap(), W = new WeakMap(), Se = new WeakMap(), M = new WeakMap(), q = new WeakMap(), P = new WeakMap(), B = new WeakMap(), ae = new WeakMap(), Te = new WeakMap(), pe = new WeakMap(), je = new WeakMap(), Xe = new WeakMap(), et = new WeakMap(), le = new WeakMap(), gt = new WeakMap(), x = new WeakSet(), Oi = function() {
  try {
    _(this, q, be(() => s(this, Se).call(this, s(this, V))));
  } catch (t) {
    this.error(t);
  }
}, /**
...
Di = function(t) {
  ...
  t && (this.is_pending = !0, _(this, P, be(() => t(s(this, V)))), Pe(() => {
    var n = _(this, ae, document.createDocumentFragment()), i = Nn();
    n.append(i), _(this, q, E(this, x, ft).call(this, () => be(() => s(this, Se).call(this, i)))), s(this, pe) === 0 && (s(this, V).before(n), _(this, ae, null), ct(
      /** @type {Effect} */
      s(this, P),
      () => {
        _(this, P, null);
  ...
  try {
    if (this.is_pending = this.has_pending_snippet(), _(this, pe, 0), _(this, Te, 0), _(this, q, be(() => {
      s(this, Se).call(this, s(this, V));
    })), s(this, pe) > 0) {
...
Ot = function(t, n) {
  ...
  _(this, pe, s(this, pe) + t), s(this, pe) === 0 && (E(this, x, ut).call(this, n), s(this, P) && ct(s(this, P), () => {
    _(this, P, null);
  }), s(this, ae) && (s(this, V).before(s(this, ae)), _(this, ae, null)));
}, /**
 * @param {unknown} error
 */
Dt = function(t) {
  s(this, q) && (te(s(this, q)), _(this, q, null)), s(this, P) && (te(s(this, P)), _(this, P, null)), s(this, B) && (te(s(this, B)), _(this, B, null));
  var n = s(this, W).onerror;
  let i = s(this, W).failed;
  var r = !1, a = !1;
  const f = () => {
    if (r) {
      bi();
    ...
    r = !0, a && _i(), s(this, B) !== null && ct(s(this, B), () => {
      _(this, B, null);
    ...
    i && _(this, B, E(this, x, ft).call(this, () => {
      try {
        return be(() => {
          var l = (
            /** @type {Effect} */
...
function Sn(e, t, n = null) {
  if (!e.equals(t)) {
    ...
    if (i.capture(e, t), (e.f & D) !== 0) {
      ...
      (e.f & F) !== 0 && Vt(r), C === null && Lt(r);
    }
    e.wv = jn(), Tn(e, F, n), bt() && y !== null && (y.f & N) !== 0 && (y.f & (oe | _e)) === 0 && (G === null ? Ji([e]) : G.push(e)), !i.is_fork && Pt.size > 0 && !xn && zi();
  }
  return t;
}
function zi() {
    ...
    for (var r = bt(), a = i.length, f = 0; f < a; f++) {
      ...
      if (!(!r && u === y)) {
        ...
        if (l && T(u, t), (o & D) !== 0) {
          ...
          (o & X) !== 0 && H !== null && H.add(v), n !== null ? n.push(v) : Gt(v);
        }
      }
    }
}
    ...
    e,
    {
      ...
      get(u, o, l) {
        ...
        if (p === void 0 && (!v || (d = Ye(u, o)) != null && d.writable) && (p = f(() => {
          var c = qe(v ? u[o] : R), b = /* @__PURE__ */ fe(c);
          return b;
        }), n.set(o, p)), p !== void 0) {
          var h = he(p);
          return h === R ? void 0 : h;
      ...
      has(u, o) {
        ...
        if (l !== void 0 || y !== null && (!p || (h = Ye(u, o)) != null && h.writable)) {
          l === void 0 && (l = f(() => {
            var d = p ? qe(u[o]) : R, c = /* @__PURE__ */ fe(d);
            return c;
          }), n.set(o, l));
          var v = he(l);
          if (v === R)
      ...
      set(u, o, l, p) {
        ...
        if (v === void 0)
          (!h || (ue = Ye(u, o)) != null && ue.writable) && (v = f(() => /* @__PURE__ */ fe(void 0)), ye(v, qe(l)), n.set(o, v));
        else {
          h = v.v !== R;
          var b = f(() => qe(l));
          ye(v, b);
...
function We(e, t) {
  ...
  var r = i;
  if ((e & Ke) !== 0)
    De !== null ? De.push(i) : Be.ensure().schedule(i);
  else if (t !== null) {
    try {
      Ge(i);
    } catch (f) {
  ...
  if (r !== null && (r.parent = n, n !== null && Gi(r, n), w !== null && (w.f & D) !== 0 && (e & _e) === 0)) {
    var a = (
      /** @type {Derived} */
      w
    );
...
function Bn(e) {
  var b;
  var t = I, n = j, i = G, r = w, a = U, f = O, u = K, o = Re, l = e.f;
  I = /** @type {null | Value[]} */
  null, j = 0, G = null, w = (l & (oe | _e)) === 0 ? e : null, U = null, _t(e.ctx), K = !1, Re = ++ke, e.ac !== null && (On(() => {
    e.ac.abort(jt);
  }), e.ac = null);
  try {
    e.f |= ht;
    ...
    if (bt() && G !== null && !K && h !== null && (e.f & (D | ne | F)) === 0)
    ...
    e.f ^= ht, I = t, j = n, G = i, w = r, U = a, _t(f), K = u, Re = o;
  }
}
function Zi(e, t) {
  let n = t.reactions;
...
function he(e) {
  ...
  if (n) {
    ...
    if (me) {
      var u = f.v;
      return ((f.f & N) === 0 && f.reactions !== null || Vn(f)) && (u = Vt(f)), Ae.set(f, u), u;
    }
    var o = (f.f & Y) === 0 && !K && w !== null && (dt || (w.f & Y) !== 0), l = (f.f & Ve) === 0;
    nt(f) && (o && (f.f |= Y), kn(f)), o && !l && (En(f), Gn(f));
  }
  if (C != null && C.has(e))
    return C.get(e);
  if ((e.f & $e) !== 0)
...
function vr(e, t) {
  pn(t, !1), cr(async () => {
    ...
    const [
      ...
      import("./feed-DYy8QE9U.js").then((Kn) => Kn.c),
      import("./metrics-CVlegFTT.js"),
      import("./ocr-IRyCQx3F.js"),
      import("./providers-C_m8vVWu.js"),
      import("./summarizer-BU7ZJnTN.js"),
      import("./tts-ljiQ6hLO.js"),
      import("./voices-DrFZ_nUB.js")
    ]);
    A(), Wn(), Hn(), ue(), qn({ synthesizeText: Un }), Yn(), z();
  }), fr();
