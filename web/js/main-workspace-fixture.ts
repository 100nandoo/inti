...
export function renderMainWorkspaceFixture(navLinks: NavLink[] = []) {
        ...
        <div class="main-grid">
          <section class="panel panel-workspace inti-workspace-card card bg-base-100/90 shadow-2xl shadow-base-content/10" id="ocr-card">
            ...
            <div class="input-mode-toggle inti-input-mode-toggle" role="tablist" aria-label="Input mode">
              <button id="input-mode-ocr-btn" class="input-mode-btn" type="button" role="tab" aria-selected="false" aria-controls="ocr-input-panel">OCR</button>
              <button id="input-mode-working-text-btn" class="input-mode-btn" type="button" role="tab" aria-selected="true" aria-controls="working-text-panel">Working Text</button>
            </div>
          ...
          <section class="panel panel-result inti-workspace-card card bg-base-100/90 shadow-2xl shadow-base-content/10">
            <div class="section-heading inti-panel-heading">
              <span class="ornament inti-panel-ornament" aria-hidden="true"></span>
              <h2>Action</h2>
              <span class="source-chip badge badge-outline">Summary ready</span>
            </div>
            ...
            <div id="working-text-run-panel" class="inti-control-band working-text-run-panel">
              <div class="run-mode-toggle" role="tablist" aria-label="Action tabs">
                ...
                <button id="run-mode-summary-btn" class="run-mode-btn is-active" type="button" role="tab" aria-selected="true" aria-controls="summary-run-panel">Summary</button>
          ...
          <section class="panel panel-tts inti-workspace-card card bg-base-100/90 shadow-2xl shadow-base-content/10">
            ...
            <div class="run-mode-toggle" role="tablist" aria-label="Output tabs">
              <button id="output-tab-ocr-btn" class="run-mode-btn" type="button" role="tab" aria-selected="false" aria-controls="text-result">OCR</button>
              <button id="output-tab-summary-btn" class="run-mode-btn is-active" type="button" role="tab" aria-selected="true" aria-controls="text-result">Summary</button>
              <button id="output-tab-voice-btn" class="run-mode-btn" type="button" role="tab" aria-selected="false" aria-controls="audio-result-card">Voice</button>
            </div>
            ...
            <div id="text-result" class="field-block inti-surface">
              ...
              <div class="summary-actions result-actions inti-action-row">
                ...
                <div class="dropdown dropdown-top dropdown-end split-button inti-split-button" id="result-download-group">
                  ...
                  <button id="result-download-toggle" class="btn-secondary btn btn-ghost border border-base-300 split-button-toggle" aria-haspopup="menu" aria-expanded="false" aria-controls="result-download-menu" title="Choose download format">
            ...
            <div id="voice-result-panel" class="field-block inti-surface" hidden>
              <div class="field-head">
